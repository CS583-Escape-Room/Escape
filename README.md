...
2. AFter you install fgl and split, download the Escape_func.hs, Escape_type.hs and main.hs and use GHCi load main.hs. Enter 'start' to open this game. After you start game, you can input 'help' in program to get the introduction of operation.  
