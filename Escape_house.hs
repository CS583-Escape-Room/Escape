...
ironKey = Item {item_id=8, item_name="iron key", item_info="A key which can open the desk."}
battery = Item {item_id=8, item_name="blue key", item_info="a AA battery"}
...
object25 = Objects {object_id=25, object_name="a box", object_items=[blueKey], object_connect="", object_type="obj", object_status=False, object_lock=Key battery, object_lock_info="It's locked. It has a battery bay", object_unlock_info="It's opened."}
...
object34 = Objects {object_id=34, object_name="a glass bottle", object_items=[paper1], object_connect="", object_type="obj", object_status=False, object_lock=None, object_lock_info="There is a paper in this bottle.", object_unlock_info="You broken the bottom get the paper."}
...
-- Door
door12 = Objects {object_id=51, object_name="a blue door", object_items=[], object_connect="bathroom", object_type="door", object_status=True, object_lock=None, object_lock_info="", object_unlock_info=""}
door14 = Objects {object_id=52, object_name="a wooden door", object_items=[], object_connect="study", object_type="door", object_status=False, object_lock=Key blueKey, object_lock_info="This door has a blue keyhole", object_unlock_info=""}
...
door23 = Objects {object_id=54, object_name="a white door", object_items=[], object_connect="bathroom", object_type="door", object_status=False, object_lock=Key sliverKey, object_lock_info="This door has a sliver keyhole", object_unlock_info=""}
