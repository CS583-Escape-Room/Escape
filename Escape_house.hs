...
-- | Objects
object1 = Objects {object_id=1, object_name="desk", object_items=[rkey1], object_connect="", object_type="obj", object_status=False, object_key=dkey1}
object2 = Objects {object_id=2, object_name="chair", object_items=[dkey1], object_connect="", object_type="obj", object_status=True, object_key=nokey}
object3 = Objects {object_id=3, object_name="book", object_items=[], object_connect="", object_type="obj", object_status=True, object_key=nokey}
